...
CREATE TABLE IF NOT EXISTS formula1_dev.analytics.calculated_race_results
(
  race_id INT,
  race_year INT,
  race_name STRING,
...
CREATE OR REPLACE TEMP VIEW update_calculated_race_results
AS
(
  SELECT
...
MERGE INTO formula1_dev.analytics.calculated_race_results tgt
USING update_calculated_race_results src
